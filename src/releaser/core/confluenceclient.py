...
class ConfluenceClient:
    ...
    def create_new_blog(self, space: str, title: str, message: str) -> None:
        """
        Add new blog in Confluence in the given `space`. The new blog will have
        the given `title` and content `message` in Wiki markup format.

        :param space: Confluence space.
        :param title: Blog title.
        :param message: Blog message.
        """
        logger.debug("Create new blog")

        self.__confluence_client.create_page(
            space, title, message, type="blogpost", representation="wiki"
        )
